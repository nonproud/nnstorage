<?php
  ...
  $keyword = $_GET["wordSearch"];
  $search_sql = "SELECT * FROM goods WHERE Name LIKE '%".$keyword."%'OR Describtion LIKE '%".$keyword."%'";
  $query_goods = mysqli_query($conn, $search_sql);
  $query_goods2 = mysqli_query($conn, $search_sql);
...
<!DOCTYPE html>
<html>
<title>Search @ N&N Storage</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <div class="w3-container">
    <h1><b>Search result for '<?php echo $keyword; ?>'</b></h1>
    </div>
  </header>
